...
def masked_cross_entropy_comp(logits, target, length, logits_noGrad = None, target_noGrad = None, length_noGrad = None, temperature = None, mean = None, logvar = None):
...
def masked_cross_entropy_comp_noVAE(logits, target, length):
